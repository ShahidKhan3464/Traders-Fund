...
const DirectAffiliate = () => {
    ...
    const fetchAffiliateUsers = async (pageNumber) => {
        try {
            ...
            const response = await affiliateUsersAPI(pageNumber, perPage, false)
    ...
    const fetchAffiliateEarnings = async (pageNumber) => {
        try {
            ...
            const response = await affiliateEarningsAPI(pageNumber, earningsPerPage, 'T1')
    ...
    return (<>
        <div className="space-y-6 sm:w-[90%]">
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/user-affiliate')}>
                ...
                <p className="text-gray-600">Direct Affiliate</p>
            </div>
            {/* top affiliates */}
            <div
                ...
                <div className="flex flex-col w-full gap-1 vd-box">
                    ...
                    <div className="flex items-center justify-between ">
                        <p className="text-lg">{statistics?.totalDirectAffiliates || 0}</p>
                    </div>
                </div>
                {/* Column */}
                <div className="flex flex-col w-full gap-1 vd-box">
