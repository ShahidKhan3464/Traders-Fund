...
const Transactions = ({ activeNav, setActiveNav }) => {
  useEffect(() => {
    setActiveNav(true);
  }, []);
  return (
            ...
            <div className="flex flex-col gap-10 pl-10">
              <div className="pb-10 space-y-5 0">
                <h2 className="font-bold md:text-[48px] text-[30px] leading-tight">
                  Ready to become <br /> a <span className="text-mainColor">Pro Trader?</span>
                </h2>
                <p className="font-light ">
                  Prove your skills, get funded and scale up to 3+ million dollars. You Keep 80% of the profits, we cover the losses.
                </p>

                <button className="p-3 text-black rounded-md bg-mainColor">Start PTF Challenge</button>
          ...
          <div className="flex mt-10">
            <div className="flex flex-col gap-10">
              <div className="pb-10 space-y-5">
                <h2 className="font-bold md:text-[48px] text-[30px] leading-tight">
                  Become an
                  <span className="text-mainColor"> Affiliate Partner</span> today!
                </h2>
                <p className="font-light ">
                  Invite your friends & Earn up to 25% commission INSTANTLY. They get a 10% discount OFF any purchase.
                </p>

                <button className="p-3 text-black rounded-md bg-mainColor">Become Our Partner</button>
              </div>
            </div>
            <div className="hidden mx-auto lg:block">
              <img src={globe} alt="Pro Traders Fund Dashboard" className="h-[80%]" />
            </div>
          </div>
        </div>
      </div>
